   ...
   * ******************************************************************** *
       ...
       ** Last date modified: 30 Jun 2022
       */
...
*iefolder will not work properly if the line above is edited
   ...
   * ---------------------
   ...
   if $user == 1 {
       global projectfolder "C:\Users\Cebbina\Documents\World_Bank\PCP"
   }
...
*iefolder will not work properly if the line above is edited
   ...
   *Complaints folder globals
   global Complaints             "$mastData/Complaints" 
   global Complaints_encrypt     "$encryptFolder/Master Complaints Encrypted" 
